 ...
 * Copyright (c) 2009-2011 by GangUp3, Inc. All Rights Reserved.
...
//@interface GangUp3Object : NSObject
//@end

@interface GangUp3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GangUp3Object class]])
		{
			for (NSString *key in [[(GangUp3Object*)o modules] allKeys])
			{
