...
// in simulator we redefine to format for GangUp3 Developer console
...
{\
	NSString * exceptionName = [@"org.gangup3." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gangup3";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGangUp3NativeItemNone = -1, 
	UIGangUp3NativeItemSpinner = -2,
	UIGangUp3NativeItemProgressBar = -3,
	
	UIGangUp3NativeItemSlider = -4,
	UIGangUp3NativeItemSwitch = -5,
	UIGangUp3NativeItemMultiButton = -6,
	UIGangUp3NativeItemSegmented = -7,
	
	UIGangUp3NativeItemTextView = -8,
	UIGangUp3NativeItemTextField = -9,
	UIGangUp3NativeItemSearchBar = -10,
	
	UIGangUp3NativeItemPicker = -11,
	UIGangUp3NativeItemDatePicker = -12,
	
	UIGangUp3NativeItemInfoLight = -13,
	UIGangUp3NativeItemInfoDark = -14,
	
	UIGangUp3NativeItemDisclosure = -15,
	
	UIGangUp3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GangUp3 instances of
