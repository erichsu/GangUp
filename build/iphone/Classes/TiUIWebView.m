...
static NSString * const kGangUp3Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_gangup3Injection
{
	...
	[html appendString:kGangUp3Javascript];
...
{
	// attempt to make well-formed HTML and inject in our GangUp3 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _gangup3Injection]];
