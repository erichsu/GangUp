...
/**
 The base class for all GangUp3 modules
 */
...
/**
 GangUp3 Platform calls this method on startup.
 */
-(void)startup;

/**
 GangUp3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GangUp3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GangUp3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 GangUp3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
